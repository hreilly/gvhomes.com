...
<div class="main-content-container">
    ...
    <div class="services-flex">
        <div class="services-flex-item">
            ...
            <div class="flex-item-price">
                <h5>Starting at:</h5>
                <h3>$359<span style="font-weight: 400;">*</span></h3>
            </div>
        </div>
        <div class="services-flex-item">
            ...
            <div class="flex-item-price">
                <h5>Starting at:</h5>
                <h3>$269<span style="font-weight: 400;">*</span></h3>
            </div>
        </div>
        <div class="services-flex-item">
            ...
            <div class="flex-item-price">
                <h5>Starting at:</h5>
                <h3>$239<span style="font-weight: 400;">/unit*</span></h3>
            </div>
        </div>
        <div class="services-flex-item">
            ...
            <div class="flex-item-price">
                <h5>Starting at:</h5>
                <h3>$179<span style="font-weight: 400;">*</span></h3>
            </div>
        </div>
        <div class="services-flex-item">
            ...
            <div class="flex-item-price">
                <h5>Starting at:</h5>
                <h3>$199<span style="font-weight: 400;">/unit*</span></h3>
            </div>
        </div>
    </div>
    ...
    <div class="card" style="max-width: 1024px; margin: auto;">
        ...
        <div class="card-header" id="headingOneStory">
            <h5 class="mb-0">
            <button class="btn btn-link expanded" data-toggle="collapse" data-target="#collapseOneStory" aria-expanded="false" aria-controls="collapseOneStory" style="white-space: normal; color: #252425; text-decoration: none; width: 100%;">
